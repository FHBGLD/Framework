    ...
    public function get(string $class_name): Object
    {
        ...
        foreach ($constructor->getParameters() as $parameter) {
            ...
            if (! ($type instanceof ReflectionNamedType)) {
                throw new InvalidArgumentException("Contructor parameter '{$parameter->getName()}' in the $class_name class is an invalid type: '$type' - only single named types supported");
            }
